...
| UI 요소 | 파일 | 데이터 출처 | 등급 |
|---|---|---|---|
| 유학생 탭/섹션 | `frontend/src/App.jsx` (탭·섹션 추가만) | `tab` 상태 | — |
...
| 시드 상수·목 | `frontend/src/demoData.js` (`STUDENT` 블록 추가) | seed.py 미러 | — |
| 스타일 | `frontend/src/styles.css` (`.student-*`·`.acct-*` 추가) | 기존 디자인 토큰만 참조 | — |
