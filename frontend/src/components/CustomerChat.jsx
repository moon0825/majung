...
const WELCOME = {
  vi: {
    main: "Chào mừng đến Hàn Quốc!",
    sub: "JB Majung – ra đón bạn từ ngày đầu",
    label: "Tiếng Việt",
  },
  zh: { main: "欢迎您来到韩国", sub: null, label: "中文" },
};
const WELCOME_KO = "마중: 한국에 오신 분을 먼저 나가 맞이합니다";

// E-9 페르소나 입국 상황 컨텍스트 한 줄 (표시 전용, 출처: 서울경제TV 2026.3)
const CONTEXT_LINE = {
  vi: "Vay môi giới 15 triệu KRW · lãi 30%/năm → JB hỗ trợ tái cơ cấu",
  ko: "입국 시 브로커 사채 1,500만 · 연 30% → 마중이 대환합니다",
};
    ...
    <>
      ...
      <div className="m-header">
        ...
        <div className="m-context">
          {lang === "vi" ? CONTEXT_LINE.vi : CONTEXT_LINE.ko}
        </div>
