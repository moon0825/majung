...
const WELCOME = {
  vi: {
    ...
    sub: "Tiết kiệm phí – Gửi tiền an toàn về nhà",
    label: "Tiếng Việt",
  },
  zh: {
    main: "欢迎您来到韩国",
...
// E-9 페르소나 첫 장면 컨텍스트 (표시만 — 송금 로직 불변)
const E9_STORY = "입국 시 브로커 사채 1,500만 · 연 30% → JB 마중이 먼저 나가 도와드립니다";
      ...
      <div className="m-header">
        ...
        <div className="m-welcome">
          <div className="m-welcome-text">
            ...
            <span className="vi-sub">{WELCOME[lang].sub}</span>
        ...
        <div className="m-story">{E9_STORY}</div>
