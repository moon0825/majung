...
// E-9 진입 배경 컨텍스트 (표시 전용): 마중이 해결하는 문제를 첫 화면에서 한 줄로 보여준다
const CONTEXT_KO = "입국 시 브로커 사채 1,500만·연 30% → 마중이 해결합니다";
const CONTEXT_VI = "Vay nặng lãi 30%? Majung giúp bạn.";
