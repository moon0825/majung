...
const WELCOME = {
  vi: { main: "Xin chào! Majung đồng hành cùng bạn tại Hàn Quốc", label: "Tiếng Việt" },
  zh: { main: "欢迎您来到韩国", label: "中文" },
};
const WELCOME_KO = "마중: 한국에 오신 분을 먼저 나가 맞이합니다";

// E-9 페르소나 첫 진입 컨텍스트 (표시 전용 — 출처: 서울경제TV 2026.3)
const PERSONA_PAIN = "입국 시 브로커 사채 1,500만 · 연 30% → 마중이 함께 해결합니다";
  ...
  return (
    <>
      ...
      <div className="m-header">
        ...
        <div className="m-persona" aria-label="서비스 소개">{PERSONA_PAIN}</div>
