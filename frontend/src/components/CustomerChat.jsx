...
const WELCOME = {
  vi: { main: "Xin chào Minh! Majung đồng hành cùng bạn 🇻🇳", label: "Tiếng Việt" },
  zh: { main: "欢迎您来到韩国", label: "中文" },
};
const WELCOME_KO = "마중: 한국에 오신 분을 먼저 나가 맞이합니다";
// E-9 페르소나 첫 장면 컨텍스트: 입국 시 브로커 사채 상황(표시 전용)
const PERSONA_CONTEXT = {
  ko: "입국 시 브로커 사채 1,500만 · 연 30%",
  vi: "Nợ nhập cảnh: 15tr KRW · lãi 30%/năm",
};
    ...
    <>
      ...
      <div className="m-header">
        ...
        <div className="m-persona">
          {PERSONA_CONTEXT.ko} <span className="m-persona-vi">· {PERSONA_CONTEXT.vi}</span>
        </div>
