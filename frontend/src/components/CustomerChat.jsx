...
const WELCOME = {
  vi: { main: "Xin chào! JB 마중이 먼저 나가 맞이합니다", label: "Tiếng Việt" },
  zh: { main: "欢迎您来到韩国", label: "中文" },
};
const WELCOME_KO = "마중: 한국에 오신 분을 먼저 나가 맞이합니다";

// E-9 페르소나 입국 컨텍스트 — 표시 전용, 고정 문구
const E9_CONTEXT = "입국 시 브로커 사채 1,500만 · 연 30% → JB 마중으로 대환";
  ...
  return (
    <>
      ...
      <div className="m-header">
        ...
        <div className="m-context-banner">{E9_CONTEXT}</div>
