...
const WELCOME = {
  vi: { main: "Xin chào! Chào mừng đến Hàn Quốc 🙏", label: "Tiếng Việt" },
  zh: { main: "欢迎您来到韩国", label: "中文" },
};
const WELCOME_KO = "마중: 한국에 오신 분을 먼저 나가 맞이합니다";

// E-9 페르소나 컨텍스트 1줄 — 출처: 서울경제TV 2026.3 (표시 레이어 전용, 로직 불변)
const E9_DEBT = {
  vi: "Vay tư nhân trước nhập cảnh: 1.500만 · 30%/năm",
  ko: "입국 전 브로커 사채 1,500만 원 · 연 30%",
};
  ...
  return (
    <>
      ...
      <div className="m-header">
        ...
        <div className="m-context" aria-label="입국 전 채무 현황">
          <span className="vi">{E9_DEBT.vi}</span>
          <span className="ko"> · {E9_DEBT.ko}</span>
        </div>
