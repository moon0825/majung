...
// E-9 페르소나 페인포인트 컨텍스트 — 표시 전용, 수치는 출처맵 A (서울경제TV 2026.3)
const PAIN_VI = "Vay nặng lãi trước nhập cảnh: 1.500만 KRW · 30%/năm";
const PAIN_KO = "입국 시 브로커 사채 1,500만·연 30% → JB 대환";
      ...
      <div className="m-header">
        ...
        <div className="m-welcome">
          <div className="m-welcome-text">
            ...
            {lang === "vi" && (
              <span className="pain-hint">{PAIN_VI} / {PAIN_KO}</span>
            )}
          </div>
