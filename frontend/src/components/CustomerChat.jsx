...
const WELCOME = {
  vi: { main: "Chào Minh! Chúng tôi luôn đồng hành cùng bạn", label: "Tiếng Việt" },
  zh: { main: "欢迎您来到韩国", label: "中文" },
};
const WELCOME_KO = "마중: 한국에 오신 분을 먼저 나가 맞이합니다";

// E-9 페르소나 배경 (출처: 서울경제TV 2026.3 / 출처맵 A항목)
const PERSONA_E9 = "입국 전 사채 1,500만·연 30%";
  ...
  return (
    <>
      ...
      <div className="m-header">
        ...
        <div className="m-persona-note">{PERSONA_E9}</div>
