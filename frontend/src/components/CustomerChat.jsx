...
const WELCOME = {
  vi: {
    ...
    sub: "Thoát vay lãi 30% — JB đồng hành",
    label: "Tiếng Việt",
  },
  zh: { main: "欢迎您来到韩国", label: "中文" },
};
const WELCOME_KO = "마중: 한국에 오신 분을 먼저 나가 맞이합니다";
// E-9 페르소나 첫 장면 컨텍스트 (표시 전용 — 출처: 서울경제TV 2026.3)
const E9_CONTEXT = "입국 브로커 사채 1,500만·연 30% → JB 대환 연 13.59%";
      ...
      <div className="m-header">
        ...
        <div className="m-welcome">
          <div className="m-welcome-text">
            ...
            {lang === "vi" && <span className="vi-sub">{WELCOME.vi.sub}</span>}
        ...
        <div className="m-e9-hint">{E9_CONTEXT}</div>
