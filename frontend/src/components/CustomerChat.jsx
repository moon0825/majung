...
const WELCOME = {
  vi: { main: "Xin chào! JB luôn đứng bên bạn tại Hàn Quốc 🇻🇳", label: "Tiếng Việt" },
  zh: { main: "欢迎您来到韩国", label: "中文" },
};
const WELCOME_KO = "마중: 한국에 오신 분을 먼저 나가 맞이합니다";
// 입국 전 부채 배경 — 출처맵 A항(서울경제TV 2026.3): 사채 1,500만~2,000만·연 20~40%
const PERSONA_CTX = "입국 전 사채 1,500만 · 연 30% → JB 대환 13.59%";
  ...
  return (
    <>
      ...
      <div className="m-header">
        ...
        <div className="m-persona-ctx">{PERSONA_CTX}</div>
