...
const WELCOME = {
  vi: { main: "Chào mừng! JB Bravo đồng hành từ ngày đầu tiên", label: "Tiếng Việt" },
  zh: { main: "欢迎！JB Bravo 从第一天起与您同行", label: "中文" },
};
const WELCOME_KO = "마중: 한국에 오신 분을 먼저 나가 맞이합니다";
const ENTRY_CONTEXT = "입국 시 브로커 사채 평균 1,500만·연 30% → JB 마중으로 대환";
  ...
  return (
    <>
      ...
      <div className="m-header">
        ...
        <div className="m-context">{ENTRY_CONTEXT}</div>
