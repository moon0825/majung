...
const WELCOME = {
  vi: {
    main: "Chào mừng bạn đến Hàn Quốc",
    sub: "JB 마중이 먼저 나가 맞이합니다 · Chúng tôi ở đây vì bạn",
    label: "Tiếng Việt",
  },
  zh: { main: "欢迎您来到韩国", label: "中文" },
};
const WELCOME_KO = "마중: 한국에 오신 분을 먼저 나가 맞이합니다";
// E-9 입국 첫 화면 맥락 한 줄 (출처맵 A: 서울경제TV 2026.3 기준 보수 수치)
const E9_CONTEXT = "입국 전 브로커 사채 평균 1,500만 원·연 30% → JB 마중이 지킵니다";
      ...
      <div className="m-header">
        ...
        <div className="m-welcome">
          <div className="m-welcome-text">
            ...
            {WELCOME[lang].sub && (
              <span className="vi m-welcome-sub">{WELCOME[lang].sub}</span>
            )}
        ...
        {lang === "vi" && (
          <div className="m-context-hint" role="note" aria-label="입국 전 사채 맥락 안내">
            {E9_CONTEXT}
          </div>
        )}
